            ...
            <blockquote>
              ...
              {type === "frameworks" ? (
                <div className="relative z-20 flex flex-col items-center text-center">
                  {item.logo}
                  <span className="text-lg font-semibold text-neutral-800 dark:text-gray-100 mt-4">
                    {item.name}
                  </span>
                  <span className="text-sm text-neutral-500 dark:text-gray-400 mt-1">
                    {item.title}
                  </span>
                </div>
              ) : (
